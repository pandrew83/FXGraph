...
// mdi_template.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cmdi_templateApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Cmdi_templateApp::OnAppAbout)
...
// создание Cmdi_templateApp

Cmdi_templateApp::Cmdi_templateApp()
{
	...
	SetAppID(_T("mdi_template.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Cmdi_templateApp

Cmdi_templateApp theApp;


// инициализация Cmdi_templateApp

BOOL Cmdi_templateApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_mdi_templateTYPE,
		RUNTIME_CLASS(Cmdi_templateDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(Cmdi_templateView));
	if (!pDocTemplate)
		return FALSE;
...
int Cmdi_templateApp::ExitInstance()
{
...
// обработчики сообщений Cmdi_templateApp
...
void Cmdi_templateApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Cmdi_templateApp настройка методов загрузки и сохранения

void Cmdi_templateApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Cmdi_templateApp::LoadCustomState()
{
}

void Cmdi_templateApp::SaveCustomState()
{
}
