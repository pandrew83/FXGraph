...
IMPLEMENT_SERIAL(CFXBlockSensorTRD2WPt500, CFXBlock, 1);

#define BLOCK_SENSOR_TRD_W2_M50_CURRENT		(double)0.001
#define BLOCK_SENSOR_TRD_W2_M50_MULTIPLIER	(double)35

CFXBlockSensorTRD2WPt500::CFXBlockSensorTRD2WPt500()
{
}

CFXBlockSensorTRD2WPt500::CFXBlockSensorTRD2WPt500(CFXBlock* pBlock) : CFXBlock(pBlock)
{
	m_Name = "TRD 2W Pt500";
	m_PinInMaxCount = 1;
	m_PinInMinCount = 1;
...
bool CFXBlockSensorTRD2WPt500::Calc()
{
	if (!CFXBlock::Calc())
		return false;
