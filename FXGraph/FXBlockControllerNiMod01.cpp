...
CFXBlockControllerNiMod01::CFXBlockControllerNiMod01(CFXBlock* pBlock):CFXBlockController(pBlock){
	...
	AddInputPin(Logical,_T("DI.01"),false,false,true,false);
	AddInputPin(Logical,_T("DI.02"),false,false,true,false);
	AddInputPin(Logical,_T("DI.03"),false,false,true,false);
	AddInputPin(Logical,_T("DI.04"),false,false,true,false);
	AddInputPin(Logical,_T("DI.05"),false,false,true,false);
	AddInputPin(Logical,_T("DI.06"),false,false,true,false);
	AddInputPin(Logical,_T("DI.07"),false,false,true,false);
	AddInputPin(Logical,_T("DI.08"),false,false,true,false);
	AddInputPin(Float,_T("AI.01"),false,false,true,false);
	AddInputPin(Float,_T("AI.02"),false,false,true,false);
	AddInputPin(Float,_T("AI.03"),false,false,true,false);
	AddInputPin(Float,_T("AI.04"),false,false,true,false);
	AddInputPin(Float,_T("AI.05"),false,false,true,false);
	AddInputPin(Float,_T("AI.06"),false,false,true,false);
	AddOutputPin(Logical,_T("DO.01"),false,false,false);
	AddOutputPin(Logical,_T("DO.02"),false,false,false);
	AddOutputPin(Logical,_T("DO.03"),false,false,false);
	AddOutputPin(Logical,_T("DO.04"),false,false,false);
