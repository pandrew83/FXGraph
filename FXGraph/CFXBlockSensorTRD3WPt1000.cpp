...
IMPLEMENT_SERIAL(CFXBlockSensorTRD3WPt1000, CFXBlock, 1);

#define BLOCK_SENSOR_TRD_W2_M50_CURRENT		(double)0.001
#define BLOCK_SENSOR_TRD_W2_M50_MULTIPLIER	(double)35

CFXBlockSensorTRD3WPt1000::CFXBlockSensorTRD3WPt1000()
{
}

CFXBlockSensorTRD3WPt1000::CFXBlockSensorTRD3WPt1000(CFXBlock* pBlock) : CFXBlock(pBlock)
{
	m_Name = "TRD 3W Pt1000";
	m_PinInMaxCount = 1;
	m_PinInMinCount = 1;
	m_PinOutMinCount = 1;
	m_PinOutMaxCount = 1;
...
bool CFXBlockSensorTRD3WPt1000::Calc()
{
	if (!CFXBlock::Calc())
		return false;
