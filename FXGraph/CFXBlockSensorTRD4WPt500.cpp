...
IMPLEMENT_SERIAL(CFXBlockSensorTRD4WPt500, CFXBlock, 1);

#define BLOCK_SENSOR_TRD_W2_M50_CURRENT		(double)0.001
#define BLOCK_SENSOR_TRD_W2_M50_MULTIPLIER	(double)35

CFXBlockSensorTRD4WPt500::CFXBlockSensorTRD4WPt500()
{
}

CFXBlockSensorTRD4WPt500::CFXBlockSensorTRD4WPt500(CFXBlock* pBlock) : CFXBlock(pBlock)
{
	m_Name = "TRD 4W Pt500";
	m_PinInMaxCount = 1;
	m_PinInMinCount = 1;
...
bool CFXBlockSensorTRD4WPt500::Calc()
{
	if (!CFXBlock::Calc())
		return false;
