...
IMPLEMENT_SERIAL(CFXBlockSensorTRD3WM50, CFXBlock, 1);

#define BLOCK_SENSOR_TRD_W2_M50_CURRENT		(double)0.001
#define BLOCK_SENSOR_TRD_W2_M50_MULTIPLIER	(double)35

CFXBlockSensorTRD3WM50::CFXBlockSensorTRD3WM50()
{
}

CFXBlockSensorTRD3WM50::CFXBlockSensorTRD3WM50(CFXBlock* pBlock) : CFXBlock(pBlock)
{
	m_Name = "TRD 3W M50";
	m_PinInMaxCount = 1;
	m_PinInMinCount = 1;
...
bool CFXBlockSensorTRD3WM50::Calc()
{
	if (!CFXBlock::Calc())
		return false;
