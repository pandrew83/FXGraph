...
CFXBlockSensorTRD3WPt100::CFXBlockSensorTRD3WPt100()
{
}

CFXBlockSensorTRD3WPt100::CFXBlockSensorTRD3WPt100(CFXBlock* pBlock) : CFXBlock(pBlock)
{
	m_Name = "TRD 3W Pt100";
	m_PinInMaxCount = 1;
	m_PinInMinCount = 1;
...
bool CFXBlockSensorTRD3WPt100::Calc()
{
	if (!CFXBlock::Calc())
		return false;
